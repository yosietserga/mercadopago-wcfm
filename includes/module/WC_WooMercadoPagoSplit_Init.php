...
class WC_WooMercadoPagoSplit_Init
{
    ...
    {
        $type = 'error';
        $message = esc_html__('Mercado Pago Split (WooCommerce + WCFM) requires PHP version 5.6 or later. Please update your PHP version.', 'woocommerce-mercadopago-split');
    ...
    public static function woocommerce_mercadopago_init()
    {
        ...
        if (class_exists('WC_Payment_Gateway')) {
            require_once dirname(__FILE__) . '/config/WC_WooMercadoPagoSplit_Constants.php';
            require_once dirname(__FILE__) . '/WC_WooMercadoPagoSplit_Exception.php';
